      ...
      >
        <div className="container">
          <div className="grid  grid-cols-3 grid-rows-1 items-center ">
            <div className="col-span-3  md:col-span-1  relative mr-6 ">
              <div className="mb-10">
                <img
                  src="/images/xora.svg"
                  width={160}
            ...
            <div className="md:col-span-2 mb-10 max-md:hidden">
              <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-[#263466] p-6">
