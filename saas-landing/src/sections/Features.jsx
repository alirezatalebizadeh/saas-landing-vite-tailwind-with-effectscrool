    ...
    <Element name="خدمات">
      <section className="features" >
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-[#334679] rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            {features.map(({ id, icon, caption, title, text, button }) => (
              <div key={id} className="relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 max-md:border-2 max-md:border-[#334679] max-md:rounded-3xl max-md:flex-320">
                ...
                <h2 className="max-w-400 mb-7 h3 text-[#EAEDFF] max-md:mb-6 max-md:h5">
                  {title}
                </h2>
            ...
            <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-[#334679] rounded-7xl max-md:grid grid-cols-2">
