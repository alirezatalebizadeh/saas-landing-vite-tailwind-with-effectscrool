    ...
    return (
        <div className='relative z-2 mb-16'>
            <div className="group relative flex cursor-pointer items-start justify-between gap-5 px-7"
                ...
                <div className={`faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-[#0C1838] shadow-400 transition-all duration-500 group-hover:border-[#1959AD] ${active && "before:bg-[#2EF2FF] after:rotate-0 after:bg-[#2EF2FF]"}`}>
